...
in {
  options.blastdan.user = with types; {
    ...
    fullName = mkOpt str "Dan McCrady" "The full name of the user.";
    email = mkOpt str "blast.dan@gmail.com" "The email of the user.";
    initialPassword =
      mkOpt str "password"
          ...
          zsh = {
            ...
            initExtra =
              ...
              + optionalString cfg.prompt-init ''
                ${pkgs.toilet}/bin/toilet -f future "Welcome to the BoomBox" --gay
              '';
